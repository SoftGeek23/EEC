...
def simulate_access(address, write=False, is_instruction=False):
    ...
    if l1_hit:
        ...
        if is_instruction:
            l1_inst_hits += 1
            l1_inst_energy_j += L1_POWER_RW * L1_ACCESS_TIME
        else:
            l1_data_hits += 1
            l1_data_energy_j += L1_POWER_RW * L1_ACCESS_TIME
    else:
...
with open('output.txt', 'a') as output_file:
    ...
    for trace_file_path in trace_files:
        ...
        for l2_assoc in associativities:
            ...
            average_access_time_ns = time_ns / total_accesses if total_accesses else float('inf')
